...
## Layer 1: Verify access (steps 1 to 6)
...
## Layer 2: Machine-readable architecture (steps 7 to 12)
...
## Layer 3: Content that answers real questions (steps 13 to 18)
...
## Layer 4: Authority that corroborates (steps 19 to 22)
...
## Layer 5: Dated measurement (steps 23 to 25)
