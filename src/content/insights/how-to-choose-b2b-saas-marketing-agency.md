---
title: 'How to Choose a B2B SaaS Marketing Agency: The Due-Diligence Set'
seoTitle: 'How to Choose a B2B SaaS Marketing Agency'
description: 'Twenty evaluation questions for choosing a B2B SaaS marketing agency, each with what a strong answer and an evasive answer sound like. Includes three evidence tests to run before signing.'
...
methodologyVersion: 'Vendor due-diligence set v1.0'
sources:
  - label: 'Data Decision Consulting: methodology (the work standard this guide tells buyers to demand)'
...
## Tier 2: Evidence of work

This is the tier most buyers skip, and most agencies hope they will.

**6. Show me a work ledger, not a case study.**
...
**9. How do you reconcile GA4 with our CRM?**
Strong: treats them as different systems counting different things and describes a reconciliation method. Evasive: "GA4 is accurate" or "trust the CRM." Both answers mean they will report numbers you cannot defend to a CFO. The [reconciliation framework](/insights/ga4-vs-crm-lead-reconciliation/) is the reference answer.

**10. Which of the results you show us are modeled versus counted?**
Strong: distinguishes observed data, modeled data and estimates without being asked twice. Evasive: blends them into single dashboards.

**11. What is your sample size, and what cannot it prove?**
Strong: states counts, windows and confidence honestly. Evasive: percentages without denominators. The [small-sample discipline](/insights/small-conversion-samples-inference/) exists because this failure is common.

**12. Show me a deliverable from a lapsed engagement, redacted.**
Strong: willing. Evasive: "confidential" for everything. Some confidentiality is normal; total opacity is not.

**13. What do you publish that we can verify right now?**
Strong: articles, methods, tools you can check in minutes. Evasive: nothing public. We publish our [methodology](/methodology/) and free [tools](/tools/) precisely so buyers can run this test on us.

## Tier 3: Commercial terms

**14. What does the retainer not include?**
Strong: a written exclusions list. Evasive: "we are flexible." Flexibility before signing becomes scope creep after.

**15. What is the minimum commitment, and what happens if we pause?**
...
**18. Who pays for tools and media, and who owns the vendor relationships?**
Strong: transparent costs, client-owned relationships. Evasive: markup opacity.

**19. What reporting cadence do you propose, and what will the first report contain?**
...
First, the work-ledger test. The most predictive single question we can offer, based on what evidence-led practice looks like from the inside.
