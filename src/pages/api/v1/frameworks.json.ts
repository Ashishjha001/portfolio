 ...
 * Exposes every DataDecision framework (definition, inputs, calculation,
...
export async function GET() {
  const payload = {
    ...
    description:
      'Public DataDecision framework index. Each framework carries its definition, inputs, calculation, interpretation and named limitations.',
